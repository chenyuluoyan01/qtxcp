    ...
    <div>
        ...
        <Card :title="detail.orderType | getOrderType">
            <div v-if='detail.orderType == "0" || detail.orderType == "1" ||  detail.orderType == "2" ||  detail.orderType == "6"' style="max-height:50vh;overflow-y:auto;position:relative;">
                <table class="table table-hover" v-if='detail.orderType == "6"'>
                    <thead>
                        <th>商品名</th>
                ...
                <table class="table table-hover" v-if='detail.orderType == "2"'>
                    <thead>
                        <th>商品名</th>
                        <th style="width:180px;">商品价格</th>
                    </thead>
                ...
                <table class="table table-hover" v-if='detail.orderType != "2"&&detail.orderType != "6"'>
                    <thead>

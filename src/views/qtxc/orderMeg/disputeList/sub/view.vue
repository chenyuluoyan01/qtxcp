            ...
            <TabPane label="订单基本信息" name="name1">
                <div class="i-form">
                    <Form :ref="formData.rel" :model="formData.rel" :label-width="120">
                        ...
                        <FormItem label="联系人：">
                            <span v-if='detail.orderType != "6"'>{{detail.userCarNickName}}</span>
                            <span v-else>{{detail.contacts}}</span>
                        </FormItem>
                        <FormItem label="手机号：">
                            <span v-if='detail.orderType != "6"'>{{detail.contactsPhone}}</span>
                            <span v-else>{{detail.userCarPhone}}</span>
                        </FormItem>
                    </Form>
                </div>
            </TabPane>

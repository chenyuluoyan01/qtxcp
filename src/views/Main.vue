        ...
        <div class="main" :class="{'main-hide-text': shrink}">
            ...
            <div class="main-header-con" :style="{paddingLeft: '0px'}">
                <div class="main-header">
                    <div style="padding:8px;" :style="{width: shrink ? '60px' : '200px'}">
...
<script>
    ...
    export default {
        ...
        methods: {
            getAfterOrder () {
                this.post(Api.order.get,{orderStatus:"3"},res=>{
                  this.afterCount = res.pageBean.totolSize;
                  $(".brage").text(this.afterCount);
                  this.$Event.$emit("afterCount",this.afterCount);
                })
            },
            cancelEditPass () {
            ...
            saveEditPass () {
                this.$refs['editPasswordForm'].validate((valid) => {
                    if (valid) {
                        ...
                        this.post(Api.updatePass,data,res=>{
